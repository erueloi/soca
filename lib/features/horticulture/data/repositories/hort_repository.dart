      ...
      HortRotationPattern(
        ...
        stages: [
          ...
          HortRotationStage(
            ...
            label: 'Any 2 - Primavera',
            exigency: HortExigenciaNutrients.millorant,
            mainCropId: idMongeta,
          ),
          HortRotationStage(
            stageIndex: 3,
            label: 'Any 2 - Tardor',
            exigency: HortExigenciaNutrients.mitjanamentExigent,
            mainCropId: idEspinac,
          ),
        ],
      ),
      HortRotationPattern(
      ...
      HortRotationPattern(
        ...
        stages: [
          HortRotationStage(
            ...
            label: 'Any 1 - Primavera',
            exigency: HortExigenciaNutrients.moltExigent,
            mainCropId: idAlberginia,
            auxiliaryCropIds: [idPebrot],
          ),
          HortRotationStage(
            stageIndex: 1,
            label: 'Any 1 - Tardor',
